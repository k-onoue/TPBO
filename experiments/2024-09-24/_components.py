...
def run_bo(experiment_settings):
    ...
    objective_function = AddNoise(
        objective_function, strength=noise_strength, noise_type=noise_type
    )
...
def run_bo_compare(experiment_settings):
    ...
    for i in range(num_iterations):
        ...
        surrogate_model_2 = update_surrogate_model(
            surrogate_model_2, rng_key_1, X_history, y_history, data_transformer
        )
