...
def parse_args():
    ...
    parser.add_argument(
        "--noise_type",
        choices=["normal", "t", "uniform"],
        default="normal",
        help="Noise type for objective function",
    )
    parser.add_argument(
        "--noise_strength",
        type=float,
...
if __name__ == "__main__":
    ...
    settings = {
        "name": f"{name}_{args.objective}_AGT_{args.acquisition}_noise{args.noise_strength}_seed{seed}",  # Experiment name
        ...
        "noise_type": args.noise_type,  # Noise type for objective function
